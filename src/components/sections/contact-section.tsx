...
const socialLinks = [
  ...
  { name: 'Reddit', href: 'https://www.reddit.com/user/Same-Scallion-8467/', color: 'hover:bg-orange-500', icon: <path d="M22.5 10.5c-1.1 0-2 .9-2 2 0 .5.2 1 .5 1.4-1.8 1-3.4 2.4-4 3.4-.3.5-.3 1.2-.3 2 0 .6-.6 1.2-1.3 1.2-.8 0-1.3-.6-1.3-1.2 0-.8 0-1.6-.3-2-.6-1-2.2-2.4-4-3.4.3-.4.5-.9.5-1.4 0-1.1-.9-2-2-2-.5 0-1 .2-1.4.6-.6.6-.8 1.4-.6 2.2C2 12 6.5 17.6 12 17.6s10-5.6 10.6-4.3c.2-.8 0-1.6-.6-2.2-.5-.4-.9-.6-1.5-.6zM14 11c0 .8-.7 1.5-1.5 1.5S11 11.8 11 11c0-.8.7-1.5 1.5-1.5S14 10.2 14 11zm-6 0c0 .8-.7 1.5-1.5 1.5S5 11.8 5 11c0-.8.7-1.5 1.5-1.5S8 10.2 8 11zM9.5 5.5c.8 0 1.6.6 1.8 1.3L17 8l-2.2 2.2c-.2-.6-1-.9-1.8-.9-1 0-1.8.9-1.8 1.9 0 .2 0 .4.1.6C6.5 12 4.2 9.4 3.9 8.7c-.3-.7-.1-1.5.6-2.1.6-.6 1.4-.9 2.1-.6C7.5 6.6 8.5 5.5 9.5 5.5z" /> },
 
  { name: 'BlueSky', href: 'https://bsky.app/profile/ramsandota01.bsky.social', color: 'hover:bg-sky-500', icon: <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm4.3 8.4c-.2 1.1-1 2-2 2.5-.9.5-2 .7-3.2.7-1.6 0-3.1-.6-4.2-1.6-.4-.3-.7-.7-.9-1.1.7.2 1.5.1 2-.2.7-.4 1-1.1 1-1.9 0-.8-.4-1.6-1.1-2.1 1.1-.1 2.1.1 2.9.6 1 .6 1.8 1.6 2.6 2.5.7.8 1.8 1 2.6.4.1-.1.2-.3.3-.4-.3.1-.6 0-.9-.1z" /> },
{name:'Threads', href:'https://www.threads.com/@ramban_o01?__pwa=1', color:'hover:bg-pink-500', icon:<path d="M8,8c0,0,8,8,8,8c0,0,8,-8,8,-8c0,0,-8,-8,-8,-8C9,9,9,9,9,9C9,9,9,9,9,9z" /> },
];
          ...
          <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            <div className="card-glass rounded-2xl p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-indigo-500/30 hover:bg-white/[0.04] transition-all group">
                  <a
                  ...
                  <CopyButton value="ramsandota@gmail.com" />
                </div>

                <div className="flex items-center justify-between p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-emerald-500/30 hover:bg-white/[0.04] transition-all group">
                  <a
